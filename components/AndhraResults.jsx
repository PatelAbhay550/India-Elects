...
const ElectionResults = ({ results }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-yellow-50">
      {/* Hero Header Section */}
      <div className="bg-gradient-to-r from-orange-600 via-red-600 to-yellow-600 text-white shadow-xl">
        <div className="container mx-auto px-6 py-8">
          <Link href="/" className="inline-block group mb-4">
            <div className="flex items-center space-x-3">
              ...
              <h2 className="text-2xl font-bold group-hover:text-orange-100 transition-colors duration-300">
                IndiaElects
              </h2>
            </div>
          </Link>
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div>
              <h1 className="text-4xl lg:text-5xl font-bold mb-2">
                🏛️ Andhra Pradesh Assembly Results 2024
              </h1>
              <p className="text-orange-100 text-lg">
                Complete constituency-wise results and analysis
              </p>
            </div>
              ...
              <div key={stateName} className="space-y-8">
                  ...
                  <div className="p-8 text-white">
                    <div className="flex flex-col lg:flex-row items-center gap-8">
                      <div className="relative">
                        <div className="w-40 h-40 rounded-full overflow-hidden border-4 border-white shadow-xl">
                          <img
                            ...
                            alt="Andhra Pradesh Chief Minister - N Chandrababu Naidu"
                          />
                        </div>
                        <div className="absolute -bottom-2 -right-2 bg-yellow-400 text-green-800 px-3 py-1 rounded-full text-sm font-bold">
                          Winner
                        </div>
                      </div>
                      <div className="text-center lg:text-left">
                        ...
                        <p className="text-xl text-green-100 mb-3">Chief Minister-elect</p>
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
                    ...
                    <div className="p-6 bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl">
                      ...
                      <div className="text-orange-800 font-medium">Counting Complete</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                  <div className="bg-gradient-to-r from-gray-800 to-gray-700 text-white px-8 py-6">
                    ...
                    <p className="text-gray-300 mt-2">Detailed breakdown of all {stateResults.length} constituencies</p>
                  </div>
                  ...
                  <div className="p-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                      {stateResults.map((result, index) => (
                        <div
                          key={index}
                          className="group bg-gradient-to-br from-white to-gray-50 border border-gray-200 rounded-xl p-6 hover:shadow-xl hover:border-orange-300 transition-all duration-300 transform hover:-translate-y-1"
                        >
                          {/* Constituency Header */}
                          ...
                          <div className="bg-orange-50 p-4 rounded-lg">
                            <div className="flex items-center justify-between">
                              <span className="text-sm font-medium text-orange-800">Victory Margin</span>
